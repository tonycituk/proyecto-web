...
export function FormResumenEntrada({ data }: Props) {
	return (
		<>
			...
			<div className="drop-shadow-xl mx-auto rounded-md bg-blanco w-11/12 md:w-[760px] h-auto border-slate-700 py-5 px-8 mb-8">
				<ul>
					<li className="flex items-center ">
						...
						<p className="text-lg">{data.procedencia}</p>
					</li>
					<li className="flex items-center">
						<p className="uppercase font-bold mr-2 my-[13px] text-lg"> Número de factura: </p>
						<p className="text-lg">{data.factura}</p>
					</li>
					<li className="flex items-center">
						<p className="uppercase font-bold mr-2 my-[13px] text-lg"> Tipo de procedencia: </p>
						<p className="text-lg">{data.tipo}</p>
					</li>
					<li className="flex items-center">
					...
					<div key={`Producto ${index}`} className="drop-shadow-xl mx-auto my-8 rounded-md bg-blanco w-11/12 md:w-[760px] h-auto border-slate-700 px-4 md:px-8 py-8">
						<ul>
							...
							<li className="flex items-center">
								...
								<p className="text-lg">{`$${cantidad * precio}`}</p>
							</li>
							<li className="flex items-center">
